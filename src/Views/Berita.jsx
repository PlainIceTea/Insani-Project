    ...
    <>
      <div className="w-full font-montserrat py-10">
        <div className="w-11/12 mx-auto flex">
          ...
          <div className="text-3xl font-bold ml-5">Berita</div>
        </div>
        <div className="w-10/12 mx-auto mt-10">
          ...
          {fasilitas.map((index, i) => (
            ...
            <div className="w-full flex my-16 border px-5 hover:shadow-xl duration-200 font-montserrat" key={i}>
              <Link to="/berita/lengkap" className="w-full flex my-10">
              <img src={index.image} alt="" className="w-3/12" />
              <div className="w-full ml-5">
                <div className="font-medium text-medium">{index.header}</div>
                <div className="my-3 text-sm font-sm text-gray-400">
